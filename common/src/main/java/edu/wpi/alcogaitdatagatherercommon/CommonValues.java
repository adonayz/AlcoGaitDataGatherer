...
public class CommonValues{
    public static final int DELAYINMILLISECONDS = 1;
    ...
    public static final String CONFIRM_WALK = "confirm_walk";
    public static final String SAVE_SURVEY = "save_survey";
    public static final String REDO_PREVIOUS_WALK = "redo_previous_walk";
    public static final String RESTART_SURVEY = "restart_survey";
    public static final String WEARABLE_CONNECTED = "wearable_connected";
    ...
    public static final String DESTROY_APP = "destroy_app";
    public static final String REQUEST_WEARABLE_DATA_SAMPLE_SIZE = "request_sample_size";
    public static final int TRANSFER_FINISHED = 123456789;
}
